package rest.builder.example.internal.resource.v1_0;
...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "RestBuilderExample REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "RestBuilderExample", version = "v1.0")
)
@Path("/v1.0")
