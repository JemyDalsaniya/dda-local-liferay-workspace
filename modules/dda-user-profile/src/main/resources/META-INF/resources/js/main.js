...
$(document).ready(function () {
    ...
    function activateTabFromHash() {
        ...
        var $inboxTab = $('#nav-inbox-tab');
        var $inboxPane = $('#nav-inbox');
        ...
        if (hash) {
            var $targetTab = $navTab.find(`a[href="${hash}"]`);
            var $targetPane = $(hash);
    ...
    function activateNestedTab(tabId) {
        var $inbox = $('#nav-inbox');
        var $nestedTabs = $inbox.find('.nav-tabbs a');
        var $nestedPanes = $inbox.find('.tab-content > .tab-pane');
        ...
        var $targetNestedTab = $nestedTabs.filter(`[href="${tabId}"]`);
